package br.com.tech4me.tech4plataforma.handler;
...
@ControllerAdvice
public class PlataformaTratamentoErro extends ResponseEntityExceptionHandler  {
  ...
  protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
      HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String mensagem = "Só é aceito formato JSON, verifique o media type enviado\n" + ex.getMessage();
